...
import { getTextContent, parseDate, getAtomLink } from './util';
...
export class FeedParser {
	...
	private getItemContent(item: Element) {
		switch (this.format) {
			...
			case 'RSS':
				return item.getElementsByTagNameNS(FeedParser.RSS_NAMESPACES.CONTENT, 'encoded')[0]
					?.textContent;
		}
	}
