> [!NOTE]  
> This project has been cloned from https://github.com/JacobLinCool/d1-manager. It is a tool to provide a simple UI to get insights into the current state of the Menteka database, and to quickly update values. It is deployed at db.menteka.com, but access is highly restricted.

Small changes made to fit into this repo: 
- Removed all git settings, changeset, github, etc
